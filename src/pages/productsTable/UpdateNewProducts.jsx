    ...
    useEffect(() => {
        if (productUpdateObj) {
            setFormData({
                ...
                articles: productUpdateObj.articles?.length > 0
                    ...
                    <div className="form_group">
                        ...
                        {previewUrl ? (
                            <div className="image_preview_wrapper">
                                <img src={previewUrl} alt="Məhsul şəkli" style={{ width: 150, height: 150, objectFit: 'cover' }} />
                                <button type="button" className='change_image_btn' onClick={() => {
