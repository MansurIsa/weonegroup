        ...
        <div className='filter_products_parent_container'>
            <div className="filter_products_serach_btn">
                <div className='filter_products_serach'>
                    ...
                    <input placeholder='Məhsulu axtar...' type="text" />
                </div>
                <button>Markalar</button>
            </div>
            <div className="filter_products_categories">
                <button>Hamısı</button>
                <button>Mühərrik hissələri</button>
                <button>Əyləc sistemləri</button>
                <button>Mühərrik hissələri</button>
                <button>Asqı və sükan hissələri</button>
                <button>Mühərrik hissələri</button>
            </div>
